        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeeUl9IZDN97pBQNgeunx6dD1df-4g7vkPFw&usqp=CAU"
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <li class="user-footer">
                        <a href="#" class="btn btn-default btn-flat">SOBRE</a>
...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        ...
        <strong>
           Copyright &copy; 2014-2021 <a href="https://www.linkedin.com/in/isaias-vasconcelos-58a045232/">Isaias Vasconcelos</a>.
        </strong>
        All rights reserved.
    </footer>
</div>
